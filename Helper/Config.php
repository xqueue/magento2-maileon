...
class Config
{
    public const XML_PATH_API_KEY = 'xqueue-maileon/general/api_key';
    public const XML_PATH_NL_ENABLED = 'xqueue-maileon/newsletter_settings/active_modul';
    public const XML_PATH_NL_PERMISSION = 'xqueue-maileon/newsletter_settings/permission';
    public const XML_PATH_NL_DOI_PROCESS = 'xqueue-maileon/newsletter_settings/doi_process';
    public const XML_PATH_NL_DOI_PLUS = 'xqueue-maileon/newsletter_settings/doi_plus_process';
    public const XML_PATH_NL_DOI_KEY = 'xqueue-maileon/newsletter_settings/doi_key';
    public const XML_PATH_NL_UNSUB_TOKEN = 'xqueue-maileon/newsletter_settings/unsubscribe_token';
    public const XML_PATH_NL_DOI_TOKEN = 'xqueue-maileon/newsletter_settings/doi_token';
    public const XML_PATH_NL_UNSUB_ALL = 'xqueue-maileon/newsletter_settings/unsubscribe_all_emails';
    public const XML_PATH_NL_DISABLE_CONFIRM_EMAIL = 'xqueue-maileon/newsletter_settings/disable_request_email';
    public const XML_PATH_NL_DISABLE_SUCCESS_EMAIL = 'xqueue-maileon/newsletter_settings/disable_success_email';
    public const XML_PATH_NL_DISABLE_UNSUB_EMAIL = 'xqueue-maileon/newsletter_settings/disable_unsubscription_email';
    public const XML_PATH_ORD_CONF_ENABLED = 'xqueue-maileon/orders/active_modul';
    public const XML_PATH_ORD_CONF_DISABLE_ORDER_EMAIL = 'xqueue-maileon/orders/disable_order_emails';
    public const XML_PATH_ORD_CONF_BUYERS_PERM_ENABLED = 'xqueue-maileon/orders/buyers_permission_enabled';
    public const XML_PATH_ORD_CONF_BUYERS_TX_PERM = 'xqueue-maileon/orders/buyers_transaction_permission';
    public const XML_PATH_CUSTOMER_TX_CRED_CHANGED = 'xqueue-maileon/customer_related_transactions/credentials_changed';
    public const XML_PATH_DISABLE_CRED_CHANGED_EMAIL = 'xqueue-maileon/customer_related_transactions/disable_credential_changed_email';
    public const XML_PATH_CUSTOMER_TX_PSW_REMINDER = 'xqueue-maileon/customer_related_transactions/password_reminder';
    public const XML_PATH_DISABLE_PSW_REMINDER_EMAIL = 'xqueue-maileon/customer_related_transactions/disable_password_reminder_email';
    public const XML_PATH_CUSTOMER_TX_PSW_RESET = 'xqueue-maileon/customer_related_transactions/password_reset_confirm';
    public const XML_PATH_DISABLE_PSW_RESET_EMAIL = 'xqueue-maileon/customer_related_transactions/disable_password_reset_email';
    public const XML_PATH_CUSTOMER_TX_NEW_ACCOUNT = 'xqueue-maileon/customer_related_transactions/new_account';
    public const XML_PATH_DISABLE_NEW_ACCOUNT_EMAIL = 'xqueue-maileon/customer_related_transactions/disable_new_account_email';
    public const XML_PATH_ORD_TX_CREDIT_MEMO = 'xqueue-maileon/order_related_transactions/credit_memo';
    public const XML_PATH_DISABLE_CREDIT_MEMO_EMAIL = 'xqueue-maileon/order_related_transactions/disable_credit_memo_email';
    public const XML_PATH_ORD_TX_INVOICE = 'xqueue-maileon/order_related_transactions/invoice';
    public const XML_PATH_DISABLE_INVOICE_EMAIL = 'xqueue-maileon/order_related_transactions/disable_invoice_email';
    public const XML_PATH_ORD_TX_ORDER_STATUS = 'xqueue-maileon/order_related_transactions/order_status';
    public const XML_PATH_DISABLE_ORDER_STATUS_EMAIL = 'xqueue-maileon/order_related_transactions/disable_order_status_email';
    public const XML_PATH_ORD_TX_SHIPMENT_STATUS = 'xqueue-maileon/order_related_transactions/shipment_status';
    public const XML_PATH_DISABLE_SHIPMENT_STATUS_EMAIL = 'xqueue-maileon/order_related_transactions/disable_shipment_status_email';
    public const XML_PATH_ABAN_CART_ENABLED = 'xqueue-maileon/abandoned_cart/active_modul';
    public const XML_PATH_ABAN_CART_PERMISSION = 'xqueue-maileon/abandoned_cart/permission';
    public const XML_PATH_ABAN_CART_HOURS = 'xqueue-maileon/abandoned_cart/hours';
    public const XML_PATH_ABAN_CART_SHADOW_EMAIL = 'xqueue-maileon/abandoned_cart/shadow_email';
    public const XML_PATH_ABAN_CART_EMAIL_OVERRIDE = 'xqueue-maileon/abandoned_cart/email_override';
