...
class OrderCommentSender extends MaileonSender
{
    /**
     ...
     *
     * @param MagentoOrderCommentSender $subject
    ...
    public function aroundSend(
        ...
        if ($this->pluginConfig['orderStatus'] == 'yes') {
            ...
            $this->checkAndSend($order, $comment);
     ...
     * @return bool
     */
    protected function checkAndSend(Order $order, string $comment = '')
    {
        $this->identityContainer->setStore($order->getStore());
     ...
     * @return array
     */
    protected function createTransactionContent(Order $order, string $comment = ''): array
    {
        $content = [];
