...
use Maileon\SyncPlugin\Vendor\MaileonAPI\json\JSONSerializer;
use Maileon\SyncPlugin\Vendor\MaileonAPI\MaileonAPIException;
use Maileon\SyncPlugin\Vendor\MaileonAPI\MaileonAPIResult;
    ...
    */
    public function getRecentTransactions($type_id, $count = 1000, $minExcludedTxId = 0)
    {
        ...
        return $this->get(
            ...
            $queryParameters,
            "application/json",
            array('array', 'Maileon\SyncPlugin\Vendor\MaileonAPI\transactions\RecentTransaction')
        );
    }
}
