...
namespace Maileon\SyncPlugin\Model\Maileon;

use Maileon\SyncPlugin\Vendor\MaileonAPI\contacts\Permission;
use Maileon\SyncPlugin\Vendor\MaileonAPI\contacts\StandardContactField;
use Maileon\SyncPlugin\Vendor\MaileonAPI\contacts\SynchronizationMode;
use Maileon\SyncPlugin\Vendor\MaileonAPI\contactevents\ContactEventDataType;
use Maileon\SyncPlugin\Vendor\MaileonAPI\transactions\TransactionsDataType;
use Maileon\SyncPlugin\Vendor\MaileonAPI\transactions\TransactionsService;
use Maileon\SyncPlugin\Vendor\MaileonAPI\transactions\TransactionType;
use Maileon\SyncPlugin\Vendor\MaileonAPI\transactions\AttributeType;
use Maileon\SyncPlugin\Vendor\MaileonAPI\transactions\Transaction;
use Maileon\SyncPlugin\Vendor\MaileonAPI\transactions\ContactReference;
use Maileon\SyncPlugin\Model\Maileon\ContactCreate;
